 ...
 * 2. Si pasa, envía al endpoint store del backend
...
const submit = () => {
    ...
    form.post(route('categories.store'), {
        preserveScroll: true,
        onSuccess: () => {
            // El mensaje de éxito se mostrará mediante flash message en el layout
            // El formulario se limpia automáticamente al navegar a la página de listado
        },
        onError: (backendErrors) => {
            // Mostrar errores del backend (validación adicional en servidor)
                        ...
                        <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                            <div class="flex">
                                ...
                                <p class="text-sm text-blue-700 dark:text-blue-300">
                                    Complete el formulario para crear una nueva categoría. Los campos marcados con * son obligatorios.
                                </p>
                            </div>
                        </div>
